...
import app.features.inventorycreation.ui.components.NotificationHelperCreateInventory
...
fun CreateInventoryScreen(
    ...
    val requestPermissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted) {
            NotificationHelperCreateInventory.showNotification(context)
        }
    }
                    ...
                    Column(
                        ...
                        Button(
                            onClick = {
                                ...
                                NotificationHelperCreateInventory.createNotificationChannel(context)
                                NotificationHelperCreateInventory.askNotificationPermission(context, requestPermissionLauncher)
