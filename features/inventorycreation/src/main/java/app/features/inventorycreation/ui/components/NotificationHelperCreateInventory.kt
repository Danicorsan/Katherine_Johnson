...
object NotificationHelperCreateInventory {
    ...
    fun showNotification(context: Context) {
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentTitle(context.getString(R.string.inventory_created_title))
            .setContentText(context.getString(R.string.inventory_created_message))
